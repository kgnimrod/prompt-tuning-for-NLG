...
if __name__ == '__main__':
    ...
    argParser.add_argument("-R", "--reference", help="reference translation", required=False)
    ...
    argParser.add_argument("-m", "--metrics", help="evaluation metrics to be computed", default='bleu,meteor,ter,chrf++,bleurt')
