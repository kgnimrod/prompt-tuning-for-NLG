...
class MyTestCase(unittest.TestCase):
    ...
    def _tokenize(self, batch):
        ...
        tokenized_input = self.tokenizer.batch_encode_plus(
            inputs, padding='max_length', max_length=2000
        )
        ...
        tokenized_labels = self.tokenizer.batch_encode_plus(
            labels, padding='max_length', max_length=2000
        )
    ...
    def _train(self, config_dataset):
        ...
        train_dataset = train_dataset.map(self._tokenize, batched=True, batch_size=8)
        val_dataset = val_dataset.map(self._tokenize, batched=True, batch_size=8)
        ...
        training_args = TrainingArguments(
            ...
            eval_accumulation_steps=0,  # Number of eval steps to keep in GPU (the higher, the mor vRAM used)
